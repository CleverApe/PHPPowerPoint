...
class Styles extends AbstractPart
{
    ...
    public function writePart(PHPPowerPoint $pPHPPowerPoint)
    {
        ...
        $objWriter->writeAttribute('fo:page-width', StringHelper::numberFormat(SharedDrawing::pixelsToCentimeters(SharedDrawing::emuToPixels($pPHPPowerPoint->getLayout()->getCX())), 1) . 'cm');
        $objWriter->writeAttribute('fo:page-height', StringHelper::numberFormat(SharedDrawing::pixelsToCentimeters(SharedDrawing::emuToPixels($pPHPPowerPoint->getLayout()->getCY())), 1) . 'cm');
